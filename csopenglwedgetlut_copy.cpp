...
void CSOpenGLWedgetLut::initializeGL()
{
    ...
    qDebug() << "[lut]Load Vert FIle：" <<program->addShaderFromSourceFile(QOpenGLShader::Vertex, "D:/QtProject/tmp/HelloOpenGL/HelloOpenGL/Shaders/LUT.vert");
    qDebug() << "[lut]Load Frag FIle：" <<program->addShaderFromSourceFile(QOpenGLShader::Fragment, "D:/QtProject/tmp/HelloOpenGL/HelloOpenGL/Shaders/LUT.frag");
