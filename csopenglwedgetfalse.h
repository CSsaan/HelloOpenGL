#ifndef CSOPENGLWEDGETFALSE_H
#define CSOPENGLWEDGETFALSE_H
...
class CSOpenGLWedgetFalse : public QOpenGLWidget, protected QOpenGLExtraFunctions //QOpenGLFunctions_3_3_Core
{
    Q_OBJECT
public:
    explicit CSOpenGLWedgetFalse(QWidget *parent = nullptr);
    ~CSOpenGLWedgetFalse();
    void savepicture();
    // 计时函数
